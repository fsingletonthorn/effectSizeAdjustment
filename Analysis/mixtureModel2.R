...
jagData <- allData[ !is.na(allData$fis.o) & !is.na(allData$fis.o) & !is.na(allData$seFish.r) & !is.na(allData$seFish.o) & !is.na(allData$fis.r),] 
...
jagMod_additional <- jags.model(file = 'Analysis/BMWMod_additional2.R', 
                     data = list(orgEffect_FT = jagData$fis.o, n = length(jagData$fis.o), repTau = 1/(jagData$seFish.r^2), orgTau = 1/(jagData$seFish.o^2), repEffect_FT = jagData$fis.r,
