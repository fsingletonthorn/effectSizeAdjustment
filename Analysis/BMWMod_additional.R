...
# the observed replication effect is a function of the original effect, plus a random effect for study:
##### NOTE THAT THIS could be orgEffect_FT[i] not the trueOrgEffect[i] as it was in the original paper ~ we're interested in estimating the decrease in original effect to true effect, not the decrease from true effect to true effect
