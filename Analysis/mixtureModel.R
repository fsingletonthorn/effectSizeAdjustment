...
"
rjags::jags.model(file = 'Analysis/mixtureModel.R', 
                  data = list(orgEffect_FT = allData$fis.o, repEffect_FT = allData$fis.r, seFish.o = allData$seFish.o,  seFish.r = allData$seFish.r))
                  
  
  
model.file = modelString, 
dataList = list(study = allData$authorsTitle.o, fis.o = allData$fis.o, fis.r = allData$fis.r, seFish.o = allData$seFish.o,  seFish.r = allData$seFish.r)
parameters = 
n.chains = 4
inits.fn = NULL
n.ad
