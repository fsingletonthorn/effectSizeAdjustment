...
##### Analysis 4: Excluding studies if they have significant amounts of residual hetrogeneity 

Another way of defining "failure to replicate" is if studies have levels of residual hetrogeneity which are higher than could be explained by sampling variability alone {Hedges, 2018 #1049}. This analysis tests the null hypothesis of 0 residual hetrogeneity, using a conventional alpha of .05. In interpreting results based on this exlusion criteria, it's important to note that we are including studies based on non-significant QE test results. As Hedges and Schauer (2018) point out, this analysis implicitly puts the burdon of evidence on failure-to-replicate, saying that when we do not have enough evidence to reject the null hypothesis of a "successful" replicaiton, then we treat it as a and include it in the model. 
