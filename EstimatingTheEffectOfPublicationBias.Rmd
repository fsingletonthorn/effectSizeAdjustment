...
*Figure 5.* An illustration of the Empirical Bayes estimates for the random effect of each replication project (top panel), study (middle panel), and effect (bottom panel) in Fisher Z scores differences. The superimposed curves show the estimated distributions that each estimate is assumed to be drawn from. The colours of each point and curve show the replication project.
