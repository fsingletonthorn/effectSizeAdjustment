...
grid::grid.draw(gt)
```
Figure 5. An illustration of the Empirical Bayes estimates for the random effect of each replication project (top panel), random effects for the study (middle panel), and effect (bottom panel) in Fisher Z scores. The superimposed curves show the estimated distributions that each random effect is assumed to be drawn from. The colours of the curves and points indicates the replication project.
