...
### Analysis
This paper presents the results of three different approaches to examining the effect size difference in turn. The first approach is simply descriptive, 

All analyses were exploratory, and multiple models which were developed are not presented here. See https://github.com/fsingletonthorn/effectSizeAdjustment for a git repository with a record of all interim models and for all model code and data, and see https://osf.io/daj8b for the preregistration of this project specifying that no confirmatory analyses were planned.
