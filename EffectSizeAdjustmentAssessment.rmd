...
The bayesian mixture model is largely identical to that of Camera (see https://osf.io/xhj4d/ for thier detailed description of this model), except in that it allows for different replication projects to have different attenuation factors. 
