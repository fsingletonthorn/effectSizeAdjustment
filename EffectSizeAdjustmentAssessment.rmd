...
In order to assess whether the main results of this study are sensative to the inclusion of each of the replication projects, the models were rerun using leave one out cross validation, excluding both the individual replicaiton attempts and the replication projects one at a time. 
